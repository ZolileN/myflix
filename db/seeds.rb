...
v2 = Video.create(title: "South Park", description: "Follows the misadventures of four irreverent grade-schoolers in the quiet, dysfunctional town of South Park, Colorado.", small_cover: "http://s3.amazonaws.com/zacflix/uploads/south_park.jpg", large_cover: "http://dummyimage.com/665x375/000000/00a2ff", categories: [comedies], video_url: "http://s3.amazonaws.com/zacflix/videos/First+South+Park+Commercial+before+series+premiere%2C+1997.mp4")
...
v9 = Video.create(title: "Monk", description: "Adrian Monk is a brilliant San Francisco detective, whose obsessive compulsive disorder just happens to get in the way.", small_cover: "http://s3.amazonaws.com/zacflix/uploads/monk.jpg", large_cover: "http://s3.amazonaws.com/zacflix/uploads/monk_large.jpg", categories: [dramas], video_url: "http://s3.amazonaws.com/zacflix/videos/Monk+commercial.mp4")
